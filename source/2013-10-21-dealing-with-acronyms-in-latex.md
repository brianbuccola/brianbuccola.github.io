...
I recently stumbled on what looks to be a very useful $\LaTeX{}$ package called
`acronym`. Its purpose is to simplify the task of defining and using acronyms
(and initialisms) when writing papers in $\LaTeX{}$ --- a *very* common task in
most academic fields, including linguistics.
